...
public class MipsFrame extends Frame {
    ...
    static TempList L(TempList h, TempList t) {
    	return new TempList(h, t);
    }
    ...
    private Assem.InstrList unbumpSP() {
